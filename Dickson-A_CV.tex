...
\bibitem{Atik2026}
  Atik SB, {\bf Dickson A}* (2026) Assessing the Stability of Molecular Glues with Weighted Ensemble Simulations.
  \newblock \textit{bioRxiv}. DOI: \url{https://doi.org/10.64898/2026.01.23.701371} .

\bibitem{Bose2026}
  Bose S, Aly A, Karamyan VT, Orlando BJ, {\bf Dickson A}* (2026) Conformation Driven Enhancement of Neurolysin Activity in Presence of a Small Molecule Activator.
  \newblock \textit{bioRxiv}. DOI: \url{https://doi.org/10.64898/2026.01.05.697776} .
...
\bibitem{Kilinc2026}
  Kilinc C, Babin KM, Pioszak AA, {\bf Dickson A*} (2026) Determinants of Improved CGRP Peptide Binding Kinetics Revealed by Enhanced Molecular Simulations.
  \newblock \textit{Biophys. J.} In press.

\bibitem{Zorkany2026}
  ElZorkany HES, Kandil H, Jayaraman S, Aly A, Esfahani SH, Patel D, Dannecker D, Maciag M, Paul A, Lowran K, Kumari S, Bose S, Ostrov DA, Wu CG, {\bf Dickson A}, Abbruscato TJ, Trippier PC, Orlando BJ, Karamyan VT* (2026) Discovery of a pyridine-piperazine-based small molecule that enhances the activity of peptidase neurolysin.
  \newblock \textit{J. Pharmacol. Exp. Therapeut.} 393, 3, 103827.

\bibitem{Cottrell2026}
  Cottrell S, Yoon S, Wei X, {\bf Dickson A*}, Wei GW* (2026) Computational drug repurposing for Alzheimer's disease via sheaf theoretic population-scale analysis of snRNA-seq data.
  \newblock \textit{J. Med. Chem.} 69, 4, 4221-4238.

\bibitem{Fathi2025}
  Fathi Niazi F, Yoon S, Mbacke K, {\bf Dickson A*} (2025) Undirected exploration of binding pockets with Flexible Topology.
  \newblock \textit{J. Chem. Theory Comput.} 21, 20, 10398-10412.
...
{\bf DARPA} Network of Optimal Dynamic Energy Signatures \hfill {\bf 2026} Total: \$1.7 M USD \\
\emph{Team Green: Sequence to functional predictions through molecular simulation and AI}
{\bf PI:} Josh Vermaas (MSU)\\
{\bf Co-PI:} Alex Dickson (MSU)\\
{\bf Co-PI:} Michael Feig (MSU)\\
{\bf Co-PI:} Guowei Wei (MSU)\\
{\bf Co-PI:} Daniel Woldring (MSU)
...
\section{\sc \textcolor{blue}{ Proposals \\ Reviewed}}
        {\bf Panel Member} NIH \hfill BBM, 2026. \\
        {\bf Panel Member} NIH \hfill MIRA MCST-G, 2025.\\
...
{\bf CMSE802} \hfill {\bf Fall 2025} \\
\emph{Concepts in Computational Modeling}, 40 lecture hours.\\
An advanced graduate course that teaches a variety of computer modeling techniques including high-performance computing and machine learning.
...
{\bf Deep Generative Models in Computational Chemistry}, ACS Spring 2026.\\
{\bf Physical Chemistry Seminar}, Purdue University, October 2025.\\
{\bf Machine Learning in Chemistry}, ACS Fall 2025.\\
